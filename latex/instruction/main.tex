...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.9\textwidth]{screenshots/strona_virtual_box.png}
  \caption{Strona VirtualBox}
  \label{fig:strona-virtual-box}
\end{figure}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.9\textwidth]{screenshots/pobierz_ubuntu1.png}
  \caption{Strona Ubuntu}
  \label{fig:strona-ubuntu}
\end{figure}

\begin{figure}[h!]
  \centering
  \includegraphics[width=0.9\textwidth]{screenshots/pobierz_ubuntu_wersja.png}
  \caption{Strona Ubuntu wraz z wersją}
  \label{fig:strona-ubuntu-z-wersja-instalacji}
\end{figure}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.9\textwidth]{screenshots/virtualbox_po_instalacji.png}
  \caption{Strona VirtualBox po instalacji}
  \label{fig:strona-virtual-box-po-instalacji}
\end{figure}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.9\textwidth]{screenshots/otwarte_ubuntu.png}
  \caption{Otwarte Ubuntu}
  \label{fig:otwarte-ubuntu}
\end{figure}
