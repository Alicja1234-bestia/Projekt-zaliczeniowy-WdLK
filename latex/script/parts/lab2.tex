...
Korzystając ze wzorów \eqref{eq:sin_def}, możemy obliczyć pierwszą i drugą pochodną funkcji $f_1(x)$:
...
\begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{parts/obrazki/some_stock_photo.jpg}
